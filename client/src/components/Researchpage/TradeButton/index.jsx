...
const searchFunction = (props) => {
        ...
        return (
                ...
                <MDBContainer>
                        ...
                        <MDBRow>
                                <MDBCol size="2" md="2">
                                        <MDBCol ><a href={data.website} target="_blank" alt="company logo">
                                                <MDBView hover zoom className='companyLogo'>
                                ...
                                <MDBRow>
                                        ...
                                        <MDBCol size="3" md="3">
                                                <MDBBtn onClick={props.tradeButton} gradient="blue" className='tradeBtn'>Trade {data.symbol}</MDBBtn>
